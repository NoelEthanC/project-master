    ...
    <div class="bg-cardLight p-8 rounded-lg shadow-md max-w-md mx-auto">
      ...
      <div class="mt-8 flex items-center text-center">
        <RouterLink to="/dashboard/farmer/marketplace"
          class="bg-secondary hover:bg-tertiary mr-3 text-white font-bold py-2 px-4 rounded transition-colors duration-300"
        >
          Continue Shopping
        </RouterLink>
        <RouterLink to="/dashboard/farmer/purchases"
          class="bg-accent hover:bg-primary text-white font-bold py-2 px-4 rounded transition-colors duration-300"
        >
          view your purchases
        </RouterLink>
      </div>
